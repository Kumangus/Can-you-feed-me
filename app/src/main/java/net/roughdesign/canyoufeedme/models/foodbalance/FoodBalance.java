...
public class FoodBalance
    ...
    static private final int KEY_ALCOHOL__NON_FOOD = 2659;
    @SuppressWarnings("unused")
    static private final int KEY_APPLES = 2617;
    @SuppressWarnings("unused")
    static private final int KEY_AQUATIC_ANIMALS__OTHERS = 2769;
    @SuppressWarnings("unused")
    ...
    @SuppressWarnings("unused")
    static private final int KEY_BUTTER__GHEE = 2740;
    @SuppressWarnings("unused")
    ...
    static private final int KEY_COTTONSEED = 2559;
    ...
    @SuppressWarnings("unused")
    static private final int KEY_FATS__ANIMALS__RAW = 2737;
    static private final int KEY_FISH__BODY_OIL = 2781;
    static private final int KEY_FISH__LIVER_OIL = 2782;
    @SuppressWarnings("unused")
    ...
    @SuppressWarnings("unused")
    static private final int KEY_MARINE_FISH__OTHER = 2764;
    @SuppressWarnings("unused")
    static private final int KEY_MEAT__AQUATIC_MAMMALS = 2768;
    @SuppressWarnings("unused")
    static private final int KEY_MEAT__OTHER = 2735;
    @SuppressWarnings("unused")
    static private final int KEY_MILLET = 2517;
    static private final int KEY_MISCELLANEOUS = 2928;
    @SuppressWarnings("unused")
    static private final int KEY_MOLLUSCS__OTHER = 2767;
    @SuppressWarnings("unused")
    ...
    static private final int KEY_PALMKERNELS = 2562;
    @SuppressWarnings("unused")
    ...
    static private final int KEY_POPULATION = 2501;
    @SuppressWarnings("unused")
    ...
    static private final int KEY_RAPE_AND_MUSTARDSEED = 2558;
    @SuppressWarnings("unused")
    ...
    public double getSurplusOrDeficitInKcalPerPersonPerDay()
        {
        return getEdibleFood().getFoodSupplyInKcalPerPersonPerDay() - FoodBalance.ADVISED_KCAL_PER_PERSON_PER_DAY;
        }
